...
const PLAYER_SPRITE = {
  legend: { k: '#1a1622', h: '#5c3d22', g: '#e8c468', f: '#e8b57e', e: '#241f30', b: '#6a90c9', B: '#33547f', p: '#2c2438', o: '#4a3220', O: '#2c2018' },
  rows: [
    '..hhhh....',
    '.hhhhhhh..',
    '.hggggggh.',
...
const SLIME_SPRITE = {
  legend: { k: '#1a2e14', H: '#e8ffd8', b: '#8fd66a', B: '#4f9e3a', D: '#2e6620', e: '#152012' },
  rows: [
    '..kkkkkk..',
    '.kHbbbbbk.',
    'kBbbbbbbBk',
...
const GOBLIN_SPRITE = {
  legend: { k: '#0f1a0d', S: '#3d5c28', s: '#7fb85a', e: '#c93838', t: '#e8e0d0', a: '#8a6a3a', A: '#5a4020', c: '#c9a04a', o: '#3a2810' },
  rows: [
    'S........S',
    '.SssssssS.',
    '.sessesss.',
...
const WOLF_SPRITE = {
  legend: { k: '#141414', f: '#c9c9c9', F: '#7a7a7a', m: '#d8d0c4', n: '#0a0a0a', e: '#e8c468', P: '#3a3a3a', p: '#5f5f5f' },
  rows: [
    '..kk....kk..',
    '.kff....ffk.',
    '.kffffffffk.',
...
const DRAKE_SPRITE = {
  legend: { k: '#160808', h: '#5a1010', H: '#8a2020', s: '#c0392b', S: '#8e2418', e: '#ffd23f', w: '#6b1810', W: '#3a0e0a', b: '#e8a33d', B: '#b5792a', c: '#2a0d08' },
  rows: [
    '.....kk......',
    '....khHk.....',
    '....khHk.....',
...
const SKELETON_SPRITE = {
  legend: { k: '#1a1a1a', b: '#e8e0d0', B: '#b8b0a0', e: '#0d0d0d', n: '#f5f0e8' },
  rows: [
    '..bbbb....',
    '.bbbbbbbb.',
    'kbeeBBeebk',
...
const LICH_SPRITE = {
  legend: { k: '#08060c', h: '#d8d0c0', e: '#5aff8a', r: '#2a1f3a', R: '#1a1226', g: '#4a3d63', b: '#c8bfae', s: '#5aff8a', S: '#3a2a1a' },
  rows: [
    '..kkkkkk..',
    '.khhhhhhk.',
    '.kheehehk.',
...
const ICE_TROLL_SPRITE = {
  legend: { k: '#0a1a2a', b: '#a8d4e8', B: '#4a86a8', e: '#0d0d0d', t: '#e8f0f5', c: '#6aa8c4', C: '#9ad0e8', P: '#2a5470' },
  rows: [
    '..bbbb....',
    '.bbbbbbbb.',
    'kbeeBBeebk',
...
const FROST_WRAITH_SPRITE = {
  legend: { k: '#0a1420', h: '#c8e8f8', e: '#7af8ff', p: '#5a8ab0', P: '#8ac0e0', w: '#dff4ff', c: '#c8ecf8', r: '#2a4a68', R: '#1a3048' },
  rows: [
    '..kkkkkk..',
    '.khhhhhhk.',
    '.kheeehek.',
...
const COLOSSUS_SPRITE = {
  legend: { k: '#08141c', i: '#dff4ff', I: '#a8d8ec', e: '#7af8ff', b: '#5a8ab0', B: '#3a6a90', c: '#c8ecf8', w: '#2a4a68' },
  rows: [
    '..kiiii...',
    '.kiIIIIk..',
    'kiIeIIeIk.',
...
const HERSZT_WATAHY_SPRITE = {
  legend: { k: '#0d0a08', f: '#3a3028', h: '#8a7060', r: '#ff2a2a', s: '#9098a0', b: '#2a2018', H: '#5a4838' },
  rows: [
    '..kkkkkk..',
    '.kffffffk.',
    'kfhrhhrhfk',
...
const UPIORNY_HEROLD_SPRITE = {
  legend: { k: '#0a0a08', c: '#3a4030', b: '#e8e0c8', g: '#6ada6a', B: '#a89870', C: '#5a6048' },
  rows: [
    '..kkkkkk..',
    '.kcccccck.',
    'kcbgbbgbck',
...
const ZIMOWY_TYRAN_SPRITE = {
  legend: { k: '#0a1420', B: '#3a5468', t: '#f0f8ff', e: '#60e0ff', h: '#d8e8f0', b: '#6a8aa0' },
  rows: [
    '..kkkkkk..',
    '.kBBBBBBk.',
    'kBtettetBk',
...
const LESNY_ROZPRUWACZ_SPRITE = {
  legend: { k: '#100808', f: '#3a1818', c: '#d8d0c0', r: '#ff1010', b: '#1a0808' },
  rows: [
    '..kkkkkk..',
    '.kffffffk.',
    'kfcrccrcfk',
...
const CIENISTY_ZNIWIARZ_SPRITE = {
  legend: { k: '#1a0a24', P: '#4a2a68', g: '#c8a8e8', s: '#d8d8e0', p: '#7a4a9a' },
  rows: [
    '..kkkkkk..',
    '.kPPPPPPk.',
    'kPgsggsgPk',
...
const MROZNY_RZEZNIK_SPRITE = {
  legend: { k: '#0a1218', B: '#5a7880', c: '#c8d0d8', r: '#b81818', b: '#a8c0c8' },
  rows: [
    '..kkkkkk..',
    '.kBBBBBBk.',
    'kBcrccrcBk',
...
const TYTAN_MAGMOR_SPRITE = {
  legend: { k: '#100400', M: '#8a3418', m: '#4a1808', g: '#ff6a20', G: '#ffd040', c: '#2a0e04', w: '#ffe8a0' },
  rows: [
    '..kkkkkk..',
    '.kMMMMMMk.',
    'kMGMMMMGMk',
...
const TYTAN_MORTIS_SPRITE = {
  legend: { k: '#0a0410', B: '#8a70a8', e: '#e0a0ff', b: '#2a1040', g: '#c060ff', V: '#1a0828', w: '#f0d0ff' },
  rows: [
    '..kkkkkk..',
    '.kBBBBBBk.',
    'kBeBBBBeBk',
